  ...
  <div ref="page">
    <sticky :z-index="10" :class-name="'sub-navbar draft'">
      ...
      <div class="sticky-right">
        <el-button class="common-button" size="small" type="primary" @click="addUser()" v-preventReClick>新 增</el-button>
      </div>
    </sticky>
    <div class="app-container">
      ...
      <el-table :data="dataList" v-loading.body="listLoading" element-loading-text="Loading" fit stripe border class="table-fixed">
        ...
        <el-table-column fixed="right" label="操作" align="center" width="150">
          <template slot-scope="scope">
            <el-tag effect="dark" size="mini" type="warning" @click="goClientEdit(scope.row.id)" class="cur">修改</el-tag>
...
export default {
  ...
  methods: {
    ...
    clientListBox() {
      var _this = this
      getUserList(_this.page).then(response => {
        if (response.code === 'OK') {
